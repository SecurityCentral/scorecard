...
def update_product_data():
    ...
    for product in products:
        updated_product, _ = models.Product.objects.update_or_create(pp_id=product['id'],
        ...
        for security_role in security_roles:
            ...
            for person in people:
                ...
                if ((sec_role_desc == description_name and
                    ...
                    updated_person, _ = models.Person.objects.update_or_create(pp_id=person['id'],
                                                                               defaults={'full_name':
                    ...
                    models.ProductSecurityRole.objects.filter(role=security_role, product=updated_product,
                                                              person=None).delete()
