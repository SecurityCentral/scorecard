...
security_capabilities = [
    [security_categories[1], security_sub_categories[0],
     "Are you accounting for OWASP top 10 Critical Vuln flaws?", ""],
    [security_categories[1], security_sub_categories[0], "Documented Security Requirements", ""],
    [security_categories[1], security_sub_categories[0], "Documented Security Test Cases", ""],
    [security_categories[1], security_sub_categories[0], "Dynamic appsec testing", ""],
    [security_categories[1], security_sub_categories[0], "Manual Code Review", ""],
    [security_categories[1], security_sub_categories[0],
     "Patterns & Reference Architecture documented for Security Features", ""],
    [security_categories[1], security_sub_categories[0], "Pen testing", ""],
    [security_categories[1], security_sub_categories[0], "Prior to Packaging, Vuln/Malware/Anti-Virus scanning", ""],
    [security_categories[1], security_sub_categories[0], "Risk Assessment & Business Impact Analysis", ""],
    [security_categories[1], security_sub_categories[0], "Secure Coding Guide", ""],
    [security_categories[1], security_sub_categories[0], "Security Architecture", ""],
    [security_categories[1], security_sub_categories[0], "Security Awareness Training", ""],
    [security_categories[1], security_sub_categories[0], "Security Test Plan", ""],
    [security_categories[1], security_sub_categories[0], "Static Code Analysis", ""],
    [security_categories[1], security_sub_categories[0], "Threat Model", ""],
    ...
    [security_categories[0], security_sub_categories[1], "C2S Benchmarks", ""],
    [security_categories[0], security_sub_categories[1], "Common Criteria", ""],
    [security_categories[0], security_sub_categories[1], "FIPS 140-2", ""],
    [security_categories[0], security_sub_categories[1], "FedRAMP", ""],
    [security_categories[0], security_sub_categories[1], "HIPAA", ""],
    [security_categories[0], security_sub_categories[1], "ISO 27001:2013", ""],
    [security_categories[0], security_sub_categories[1], "NIST 800-53", ""],
    [security_categories[0], security_sub_categories[1], "PCI-DSSv3", ""]
]
